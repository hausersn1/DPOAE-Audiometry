...
params.sym_ma_M = 'd'; 
params.sym_ma_F = 'o'; 
params.color_ctrl_M = rgb('RoyalBlue'); 
params.color_ctrl_F = rgb('RoyalBlue'); 
params.color_nexp_M = rgb('DarkMagenta'); 
params.color_nexp_F = rgb('DarkMagenta'); 
params.color_ma_M = rgb('ForestGreen'); 
params.color_ma_F = rgb('ForestGreen'); 
params.MarkerSize = 40; 
params.TickLength = 0.04; 
